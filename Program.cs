    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var geometries = new Geometry[]
            {
                ...
                new RawCtMask("C:\\Users\\Alex\\Programare\\VR-lab\\Rendering3\\raw\\walnut.dat", "C:\\Users\\Alex\\Programare\\VR-lab\\Rendering3\\raw\\walnut.raw", new Vector(-5.0, -20.0, 105.0), 0.2,
                    new ColorMap()
            ...
            for (var i = 0; i < tasksCount; i++)
            {
                ...
                tasks[i] = Task.Run(() =>
                {
                    ...
                    while (k < n)
                    {
                        ...
                        var filename = "C:\\Users\\Alex\\Programare\\VR-lab\\Rendering3\\frames" + "\\" + $"{k + 1:000}" + ".png";
